...
export default function HomeContent({ courses, seasonSlug }: HomeContentProps) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans overflow-hidden">
            ...
            {/* Courses Section */}
            <section className="bg-slate-50 px-6 py-24 border-y border-slate-200">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <motion.h2 
                            variants={fadeInUp}
                            className="text-4xl md:text-5xl font-calistoga text-foreground mb-4"
                        >
                            {tCourses("page_title")}
                        </motion.h2>
