        ...
        <div className="min-h-screen">
            <div className="max-w-5xl mx-auto px-6 pt-16 pb-24 space-y-20">
                <div className="text-center">
                    <h1 className="text-4xl font-black text-foreground mb-3 tracking-tight">{t("page_title")}</h1>
                ...
                {/* Useful Links */}
                <section>
                    <h2 className="text-xl font-bold mb-8 text-foreground tracking-tight">{t("useful_links")}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            ...
                            <a
                                ...
                                className="glass-card p-6 flex items-center gap-5 group hover:bg-muted/50 transition-all duration-300"
                            >
