                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-start gap-3">
                            <input
                                type="checkbox"
                                id="terms"
                                className="mt-1 w-4 h-4 text-[#1E5AFF] border-[#E2E8F0] rounded focus:ring-[#1E5AFF]"
                                required
                            />
                            <label htmlFor="terms" className="text-sm text-[#4A5568]">
                                Я согласен с{" "}
                                <Link href="/terms" className="text-[#1E5AFF] hover:underline">
                                    условиями использования
                                </Link>{" "}
                                и{" "}
                                <Link href="/privacy" className="text-[#1E5AFF] hover:underline">
