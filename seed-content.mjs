...
const quizzes = [
    // ── Robot Design — Beginner (3) ────────────────────
    {
        ...
        question: "Дөңгелектердің симметриялы орналасуы не береді?",
        options: JSON.stringify(["Көбірек жылдамдық", "Болжамды қозғалыс", "Азырақ салмақ", "Ерекше ештеңе жоқ"]),
        correct_answer: "Болжамды қозғалыс",
        tip: "Симметрия = ауырлық орталығынан әр дөңгелекке дейінгі қашықтық бірдей. Бұл дәл бұрылыстардың кілті.",
    },
    {
        category: "robot-design", level: "beginner", type: "mcq",
        question: "«Пассивті қондырма» дегеніміз не?",
        options: JSON.stringify(["Моторы бар қондырма", "Моторы жоқ қондырма", "Қармауға арналған қондырма", "Итеруге арналған қондырма"]),
        correct_answer: "Моторы жоқ қондырма",
        tip: "Пассивті қондырмаларды жинау оңайырақ және сенімдірек. Олардан бастаңыз, тәжірибе жинаған сайын күрделілендіріңіз.",
    },
    {
        category: "robot-design", level: "beginner", type: "open",
        question: "«Қатты негіз» дегеніміз не және ол неліктен маңызды?",
        correct_answer: "Қатты негіз — бос жерлері мен икемді қосылыстары жоқ конструкция. Ол маңызды, себебі кез келген икемділік = болжанбайтын қозғалыс = миссиялардың дәлдігін жоғалту.",
        tip: "Оқушыдан негізді қолмен қозғап көруді сұраңыз. Егер бірдеңе қозғалса — бұл мәселе.",
    },
...
const checklistItems = [
    ...
    { level_id: L.RD_MID, text: "Кем дегенде бір белсенді қондырма іске асырылды", order: 1 },
    { level_id: L.RD_MID, text: "Рөлдер журналында инновация формуласы (X→Y себебі Z) қолданылады", order: 2 },
    { level_id: L.RD_MID, text: "Test Log толтырылды: болжам, нәтиже, өзгеріс", order: 3 },
    { level_id: L.RD_MID, text: "ROI команданың барлық миссиялары үшін есептелген", order: 4 },
    { level_id: L.RD_MID, text: "Барлық қатысушылар қондырманы <30 секундта ауыстыра алады", order: 5 },
...
const courses = [
    {
        level_id: L.RD_BEG,
        title: "Конструирование негіздері",
        description: "Қатты негіз, симметриялы дөңгелектер, бірінші қондырма",
        order: 1,
    },
    {
        level_id: L.IN_BEG,
        title: "Алғашқы инновациялық жоба",
        description: "Мәселені таңдау, команда рөлдері, Project Plan",
        order: 1,
    },
    {
        level_id: L.CD_BEG,
        title: "SPIKE-тегі алғашқы бағдарламалар",
        description: "Градустар vs секундтар, тірек нүктелері, Code Log",
        order: 1,
    },
    {
        level_id: L.RG_BEG,
        title: "Роботтар ойынының стратегиясы",
        description: "ROI формуласы, алаң аймақтары, миссияларды басымдыққа қою",
        order: 1,
    },
];
